...
import loadShippingAddressModel from './ShippingAddress.js'
...
const ShippingAddress = loadShippingAddressModel(sequelizeSession, Sequelize.DataTypes)

const db = { Restaurant, Order, Product, ProductCategory, RestaurantCategory, User, ShippingAddress }
...
export { Restaurant, Order, Product, ProductCategory, RestaurantCategory, User, ShippingAddress, sequelizeSession }
